...
void DECAF_API_VIS decaf_ed448_sign (
  ...
  DECAF_DEPRECATED("Passing the pubkey and privkey separately is unsafe, use decaf_ed448_keypair_sign")
#endif
;
...
#if DECAF_EDDSA_NON_KEYPAIR_API_IS_DEPRECATED
  DECAF_DEPRECATED("Passing the pubkey and privkey separately is unsafe, use decaf_ed448_keypair_sign_prehash")
#endif
;
