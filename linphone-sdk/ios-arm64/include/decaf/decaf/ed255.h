...
typedef struct decaf_eddsa_25519_keypair_s {
    uint8_t privkey[DECAF_EDDSA_25519_PRIVATE_BYTES];
    uint8_t pubkey[DECAF_EDDSA_25519_PUBLIC_BYTES];
}  decaf_eddsa_25519_keypair_s, decaf_eddsa_25519_keypair_t[1];
/** @endcond */
 ...
 * @param [in] privkey The private key.
 */    
void DECAF_API_VIS decaf_ed25519_derive_keypair (
 ...
 */    
void DECAF_API_VIS decaf_ed25519_keypair_extract_public_key (
    uint8_t pubkey[DECAF_EDDSA_25519_PUBLIC_BYTES],
 ...
 * @param [in] keypair The keypair.
 */    
void DECAF_API_VIS decaf_ed25519_keypair_extract_private_key (
    uint8_t privkey[DECAF_EDDSA_25519_PRIVATE_BYTES],
    const decaf_eddsa_25519_keypair_t keypair
) DECAF_NONNULL DECAF_NOINLINE;
 ...
 */    
void DECAF_API_VIS decaf_ed25519_keypair_destroy (
    decaf_eddsa_25519_keypair_t keypair
) DECAF_NONNULL DECAF_NOINLINE;
 ...
 *
 * @deprecated Use DECAF_API_VIS decaf_ed25519_keypair_sign instead.
 *
...
void DECAF_API_VIS decaf_ed25519_sign (
  ...
  DECAF_DEPRECATED("Passing the pubkey and privkey separately is unsafe, use decaf_ed25519_keypair_sign")
#endif
;
 ...
 * the public key is correct, and otherwise aborts.
 *
 * @deprecated Use DECAF_API_VIS decaf_ed25519_keypair_sign_prehash instead.
 *
 * @param [out] signature The signature.
 * @param [in] privkey The private key.
 * @param [in] pubkey The public key.
...
#if DECAF_EDDSA_NON_KEYPAIR_API_IS_DEPRECATED
  DECAF_DEPRECATED("Passing the pubkey and privkey separately is unsafe, use decaf_ed25519_keypair_sign_prehash")
#endif
;
 ...
 * @param [in] context_len Length of the context.
 */  
void DECAF_API_VIS decaf_ed25519_keypair_sign (
    uint8_t signature[DECAF_EDDSA_25519_SIGNATURE_BYTES],
    const decaf_eddsa_25519_keypair_t keypair,
    const uint8_t *message,
    size_t message_len,
 ...
 * @param [in] context_len Length of the context.
 */  
void DECAF_API_VIS decaf_ed25519_keypair_sign_prehash (
    uint8_t signature[DECAF_EDDSA_25519_SIGNATURE_BYTES],
    const decaf_eddsa_25519_keypair_t keypair,
    const decaf_ed25519_prehash_ctx_t hash,
    const uint8_t *context,
